// ========================================
// NXT PEÇAS V1.4 - Script Principal
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('NXT Peças V1.4 inicializado');
});
...
<body>
    ...
    <div class="watermark">NXT Peças V1.4 - Documento gerado em ${new Date().toLocaleString('pt-BR')}</div>
    ...
    <div class="etiqueta-page">
        ...
        <p style="text-align:center; font-size:9px; color:#bbb; margin-top:15px;">NXT Peças V1.4 - Etiqueta gerada em ${new Date().toLocaleString('pt-BR')}</p>
    </div>
